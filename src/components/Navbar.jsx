...
const LangSwitcher = () => (
  ...
  return (
   ...
   {menuOpen && (
  <div className="md:hidden absolute top-full left-0 w-full dark:bg-black dark:text-white bg-white text-gray rounded-xl border dark:border-black border-gray p-4 space-y-3 z-40">
